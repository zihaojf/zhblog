...
const html = () => "<p>It may be recommended to generate policies from <a href=\"https://policymaker.io\" rel=\"nofollow noopener noreferrer\" target=\"_blank\">PolicyMaker.io<span> ↗</span></a>.</p>";
				...
				const frontmatter = {"layout":"@/layouts/IndividualPage.astro","title":"Privacy Policy","description":"Effective date: 2024-11-26","language":"En","back":"/terms/list","minutesRead":"1 min read","words":8};
				const file = "D:/1大学学习/blog/astro-theme-pure-main/src/pages/terms/privacy-policy.md";
